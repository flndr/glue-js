...
namespace GlueErrors {
    ...
    export const NOT_A_DOM_ELEMENT          = "Passed variable is not a native DOM element.";
    export const ROOT_ELEMENT_FAIL          = "Configuration Error: Root element is not a DOM Node.";
    export const LAZY_IMPORT_HAS_NO_DEFAULT = "Lazy loaded module file has no default export.";
    export const MODULE_INIT_ERROR          = "Something went wrong when inititializing a module.";
}
